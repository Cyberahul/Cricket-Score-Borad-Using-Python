...
a=0  #no of over can not increase user
...
class Destination:
        def __init__(self,root):
                ...
                root.iconbitmap(r'D:\\LPU\\Semister 3\\INT 213\\Python_Cricket-project\\Cricket-Python_Project\\ball.ico')                       #fevicon icon
...
class Datastation:
        def __init__(self,root1):
                ...
                self.root1.geometry("1270x550+0+0")
                root1.iconbitmap(r'D:\\LPU\\Semister 3\\INT 213\\Python_Cricket-project\\Cricket-Python_Project\\bat.ico')          #fevicon icon
